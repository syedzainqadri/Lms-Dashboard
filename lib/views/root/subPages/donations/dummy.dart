        ...
        child: Column(
          children: [
            ...
            AdvancedPaginatedDataTable(
              ...
              customTableFooter: _customFooter ? (source, offset) {
...
class ExampleSource extends AdvancedDataTableSource<CompanyContact> {
  ...
  @override
  Future<RemoteDataSourceDetails<CompanyContact>> getNextPage(NextPageRequest pageRequest) async {
    ...
    if (response.statusCode == 200) {
      ...
      return RemoteDataSourceDetails(
        ...
        (data['rows'] as List<dynamic>).map((json) => CompanyContact.fromJson(json as Map<String, dynamic>)).toList(),
        filteredRows: lastSearchTerm.isNotEmpty ? (data['rows'] as List<dynamic>).length : null,
      );
    } else {
