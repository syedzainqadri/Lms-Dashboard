...
class _DonationsPageState extends State<DonationsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(() {
        return _donationController.isLoading.isTrue
                        ...
                        children: [
                                  ...
                                  setState(() {
                                    ...
                                    searchedModel = searchedModel
                                        .where((donations) =>
                                            ...
                                            ||
                                            donations.transactionID!.contains(
                                                _searchResult.toLowerCase()))
                                        .toList();
                                  });
                                }),
                          ...
                          DataTable2(
                            ...
                            columns: [
                              ...
                              DataColumn(
                                  label: width > 800
                                      ? textStyle2("Amount", TextAlign.center,
                                          ColorManager.blackColor)
                                      : textStyle0_5("Amount", TextAlign.center,
                                          ColorManager.blackColor),
                                  onSort: (columnIndex, _) {
                                    setState(() {
                                      _currentSortColumn = columnIndex;
                            ...
                            rows: List<DataRow>.generate(
                              ...
                              (index) => DataRow(cells: [
                                ...
                                DataCell(width > 800
                                    ? textStyle2(
                                        "${searchedModel[index].transactionID}",
                                        TextAlign.left,
                                        ColorManager.blackColor)
                                    : textStyle0_5(
                                        "${searchedModel[index].transactionID}",
