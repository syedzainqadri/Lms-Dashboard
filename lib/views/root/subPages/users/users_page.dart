...
class _UsersPageState extends State<UsersPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(() {
        return _userController.isLoading.isTrue ? const Center(child: CircularProgressIndicator())
            :
              ...
              children: [
                ...
                DataTable2(
                  ...
                  rows: List<DataRow>.generate(searchedModel.length,
                      ...
                      DataCell(width > 800
                          ? textStyle2("${searchedModel[index].phone}", TextAlign.left,
                          ColorManager.blackColor)
                          : textStyle0_5("${searchedModel[index].phone}", TextAlign.left,
                          ColorManager.blackColor)),
