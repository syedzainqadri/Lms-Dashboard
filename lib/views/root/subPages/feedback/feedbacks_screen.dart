                        ...
                        children: [
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    searchedModel = searchedModel
                                        .where((donations) => donations.project!
                                            .toLowerCase()
                                            .contains(
                          ...
                          DataTable2(
                            ...
                            columns: [
                              ...
                              DataColumn(
                                  label: width > 800
                                      ? textStyle2("Rating", TextAlign.center,
                                          ColorManager.blackColor)
                                      : textStyle0_5("Rating", TextAlign.center,
                                          ColorManager.blackColor)),
                              DataColumn(
                                  label: width > 800
                                      ? textStyle2("Remarks", TextAlign.center,
                                          ColorManager.blackColor)
                                      : textStyle0_5(
                                          "Remarks",
                                          TextAlign.center,
