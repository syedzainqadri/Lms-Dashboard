...
import '../../../../../controllers/homeBottomBanner/update_home_bottom_banner_controller.dart';
import '../../../../../models/home_bottom_banner_model.dart';

class EditHomeBottomBannerDialog extends StatefulWidget {
  final String id;
  const EditHomeBottomBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _EditHomeBottomBannerDialogState createState() => _EditHomeBottomBannerDialogState();
}

class _EditHomeBottomBannerDialogState extends State<EditHomeBottomBannerDialog> {
  ...
  final UpdateHomeBottomBannerController _updateHomeTopBannerController = Get.put(UpdateHomeBottomBannerController());
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("Edit Home Bottom Banner", TextAlign.center,
