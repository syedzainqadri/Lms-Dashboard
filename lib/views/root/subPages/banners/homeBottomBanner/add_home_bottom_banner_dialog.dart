...
class AddHomeBottomBannerDialog extends StatefulWidget {
  const AddHomeBottomBannerDialog({Key? key}) : super(key: key);

  @override
  _AddHomeBottomBannerDialogState createState() => _AddHomeBottomBannerDialogState();
}

class _AddHomeBottomBannerDialogState extends State<AddHomeBottomBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: textStyle4("Add New Home Bottom Banner", TextAlign.center,
