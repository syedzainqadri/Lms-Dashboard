...
class ViewHomeTopBannerDialog extends StatefulWidget {
  final String id;
  const ViewHomeTopBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _ViewHomeTopBannerDialogState createState() => _ViewHomeTopBannerDialogState();
}

class _ViewHomeTopBannerDialogState extends State<ViewHomeTopBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("View Home Top Banner", TextAlign.center,
