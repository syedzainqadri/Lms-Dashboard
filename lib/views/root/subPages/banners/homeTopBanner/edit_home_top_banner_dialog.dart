...
import '../../../../../controllers/homeTopBanner/update_home_top_banner_controller.dart';

class EditHomeTopBannerDialog extends StatefulWidget {
  final String id;
  const EditHomeTopBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _EditHomeTopBannerDialogState createState() => _EditHomeTopBannerDialogState();
}

class _EditHomeTopBannerDialogState extends State<EditHomeTopBannerDialog> {
  ...
  final UpdateHomeTopBannerController _updateHomeTopBannerController = Get.put(UpdateHomeTopBannerController());
  HomeTopBannerModel? bannerModel;
  XFile? image, photo;
  String? imageUrl;
  File? file;
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("Edit Home Top Banner", TextAlign.center,
