...
class AddHomeTopBannerDialog extends StatefulWidget {
  const AddHomeTopBannerDialog({Key? key}) : super(key: key);

  @override
  _AddHomeTopBannerDialogState createState() => _AddHomeTopBannerDialogState();
}

class _AddHomeTopBannerDialogState extends State<AddHomeTopBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: textStyle4("Add New Home Top Banner", TextAlign.center,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await AddHomeTopBanner().addHomeTopBanner(imageUrl, _eventUrlController.text, status);
