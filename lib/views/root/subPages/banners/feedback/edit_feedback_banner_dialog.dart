...
import '../../../../../controllers/feedback/update_feedback_banner_controller.dart';

class EditFeedbackBannerDialog extends StatefulWidget {
  final String id;
  const EditFeedbackBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _EditFeedbackBannerDialogState createState() => _EditFeedbackBannerDialogState();
}

class _EditFeedbackBannerDialogState extends State<EditFeedbackBannerDialog> {
  ...
  final UpdateFeedbackBannerController _updateHomeTopBannerController = Get.put(UpdateFeedbackBannerController());
  FeedbackBannerModel? bannerModel;
  XFile? image, photo;
  String? imageUrl;
  File? file;
