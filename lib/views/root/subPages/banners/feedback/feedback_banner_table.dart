...
import 'package:lmsadminpanle/views/root/subPages/banners/feedback/delete_feedback_banner_dialog.dart';
import 'package:lmsadminpanle/views/root/subPages/banners/feedback/edit_feedback_banner_dialog.dart';
import 'package:lmsadminpanle/views/root/subPages/banners/feedback/view_feedback_banner_dialog.dart';
import 'package:sizer/sizer.dart';
import 'package:get/get.dart';
import '../../../../../controllers/feedback/get_feedback_banner_controller.dart';

class FeedbackBannerTable extends StatefulWidget {
  const FeedbackBannerTable({Key? key}) : super(key: key);

  @override
  State<FeedbackBannerTable> createState() => _FeedbackBannerTableState();
}
class _FeedbackBannerTableState extends State<FeedbackBannerTable> {

  final GetFeedbackBannerController _homeTopBannerController = Get.put(GetFeedbackBannerController());
  List<FeedbackBannerModel> bannerModel = [];
              ...
              children: [
                Row(
                  children: [
                    ...
                    textStyle3("Feedback Banner", TextAlign.left, ColorManager.primaryColor),
                  ],
                ),
                DataTable2(
                  columnSpacing: 12,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return ViewFeedbackBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return EditFeedbackBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return DeleteFeedbackBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
