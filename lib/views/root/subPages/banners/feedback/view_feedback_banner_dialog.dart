...
class ViewFeedbackBannerDialog extends StatefulWidget {
  final String id;
  const ViewFeedbackBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _ViewFeedbackBannerDialogState createState() => _ViewFeedbackBannerDialogState();
}

class _ViewFeedbackBannerDialogState extends State<ViewFeedbackBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("View Feedback Banner", TextAlign.center,
