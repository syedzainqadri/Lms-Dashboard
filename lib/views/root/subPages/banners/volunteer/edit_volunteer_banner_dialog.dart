...
import '../../../../../controllers/volunteer/update_volunteer_banner_controller.dart';

class EditVolunteerBannerDialog extends StatefulWidget {
  final String id;
  const EditVolunteerBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _EditVolunteerBannerDialogState createState() => _EditVolunteerBannerDialogState();
}

class _EditVolunteerBannerDialogState extends State<EditVolunteerBannerDialog> {
  ...
  final UpdateVolunteerBannerController _updateHomeTopBannerController = Get.put(UpdateVolunteerBannerController());
  VolunteerBannerModel? bannerModel;
  XFile? image, photo;
  String? imageUrl;
  File? file;
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("Edit Volunteer Banner", TextAlign.center,
