...
class ViewVolunteerBannerDialog extends StatefulWidget {
  final String id;
  const ViewVolunteerBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _ViewVolunteerBannerDialogState createState() => _ViewVolunteerBannerDialogState();
}

class _ViewVolunteerBannerDialogState extends State<ViewVolunteerBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("View Volunteer Banner", TextAlign.center,
