...
import 'package:lmsadminpanle/views/root/subPages/banners/volunteer/delete_volunteer_banner_dialog.dart';
import 'package:lmsadminpanle/views/root/subPages/banners/volunteer/edit_volunteer_banner_dialog.dart';
import 'package:sizer/sizer.dart';
import 'package:get/get.dart';
import '../../../../../controllers/volunteer/get_volunteer_banner_controller.dart';
import 'view_volunteer_banner_dialog.dart';

class VolunteerBannerTable extends StatefulWidget {
  const VolunteerBannerTable({Key? key}) : super(key: key);

  @override
  State<VolunteerBannerTable> createState() => _VolunteerBannerTableState();
}
class _VolunteerBannerTableState extends State<VolunteerBannerTable> {

  final GetVolunteerBannerController _homeTopBannerController = Get.put(GetVolunteerBannerController());
  List<VolunteerBannerModel> bannerModel = [];
              ...
              children: [
                Row(
                  children: [
                    ...
                    textStyle3("Volunteer Banner", TextAlign.left, ColorManager.primaryColor),
                  ],
                ),
                DataTable2(
                  columnSpacing: 12,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return ViewVolunteerBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return EditVolunteerBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                context: context,
                                builder: (context) {
                                  return DeleteVolunteerBannerDialog(id: bannerModel[index].id!);
                                },
                              );
                            },
                          ),
