...
class AddVolunteerBannerDialog extends StatefulWidget {
  const AddVolunteerBannerDialog({Key? key}) : super(key: key);

  @override
  _AddVolunteerBannerDialogState createState() => _AddVolunteerBannerDialogState();
}

class _AddVolunteerBannerDialogState extends State<AddVolunteerBannerDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: textStyle4("Add New Volunteer Banner", TextAlign.center,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await AddVolunteerBanner().addHomeTopBanner(imageUrl, _eventUrlController.text, status);
