...
import '../../../../../controllers/eventDetail/update_eventDetail_banner_controller.dart';

class EditEventDetailBannerDialog extends StatefulWidget {
  final String id;
  const EditEventDetailBannerDialog({Key? key, required this.id}) : super(key: key);

  @override
  _EditEventDetailBannerDialogState createState() => _EditEventDetailBannerDialogState();
}

class _EditEventDetailBannerDialogState extends State<EditEventDetailBannerDialog> {
  ...
  final UpdateEventDetailBannerController _updateHomeTopBannerController = Get.put(UpdateEventDetailBannerController());
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("Edit Event Detail Banner", TextAlign.center,
