...
import '../../../../../controllers/eventDetail/delete_eventDetail_banner_controller.dart';

class DeleteEventDetailBannerDialog extends StatefulWidget {
  final String id;
  const DeleteEventDetailBannerDialog({Key? key, required this.id}) : super(key: key);
  @override
  _DeleteEventDetailBannerDialogState createState() => _DeleteEventDetailBannerDialogState();
}

class _DeleteEventDetailBannerDialogState extends State<DeleteEventDetailBannerDialog> {

  final DeleteEventDetailBannerController _deleteHomeTopBannerController = Get.put(DeleteEventDetailBannerController());
  @override
