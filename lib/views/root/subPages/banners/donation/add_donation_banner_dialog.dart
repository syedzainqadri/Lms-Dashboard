...
class AddDonationBannerDialog extends StatefulWidget {
  ...
  @override
  _AddDonationBannerDialogState createState() =>
      _AddDonationBannerDialogState();
}
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: textStyle4("Add New Donation Banner",
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await AddDonationBanner().addDonationBanner(
