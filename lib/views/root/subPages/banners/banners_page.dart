...
class _BannersPageState extends State<BannersPage> {
              ...
              children: [
                ...
                DataTable2(
                  ...
                  columns: [
                    DataColumn(
                        label: width > 800
                            ? Center(child: textStyle2("Name", TextAlign.center, ColorManager.blackColor))
                            : Center(child: textStyle0_5("Name", TextAlign.center, ColorManager.blackColor))
                    ),
                    DataColumn2(
                        label: width > 800
                            ? Center(child: textStyle2("Event Url", TextAlign.center, ColorManager.blackColor))
                            : Center(child: textStyle0_5("Event Url", TextAlign.center, ColorManager.blackColor)),
                      size: ColumnSize.L
                    ),
                    DataColumn(
                        label: width > 800
                    ...
                    DataColumn(
                        label: width > 800
                            ? Center(child: textStyle2("Image", TextAlign.center, ColorManager.blackColor))
                            : Center(child: textStyle0_5("Image", TextAlign.center, ColorManager.blackColor))
                    ),
                    DataColumn(
                        label: width > 800
                            ? Center(child: textStyle2("Action", TextAlign.center, ColorManager.blackColor))
                            : Center(child: textStyle0_5("Action", TextAlign.center, ColorManager.blackColor))
                    ),

                  ],
                  rows: List<DataRow>.generate(6, (index) => DataRow(
                      cells: [
                       DataCell(
                         index == 0 ?
                         width > 800
                             ...
                             : textStyle0_5("Home Top Banner", TextAlign.left,
                             ColorManager.blackColor)
                             :
                         index == 1 ?
                         width > 800
                                 ? textStyle2("Home Bottom Banner", TextAlign.left,
                                 ColorManager.blackColor)
                                 : textStyle0_5("Home Bottom Banner", TextAlign.left,
                                 ColorManager.blackColor)
                             :
                         index == 2 ?
                         width > 800
                             ? textStyle2("Volunteer Banner", TextAlign.left,
                             ColorManager.blackColor)
                             : textStyle0_5("Volunteer Banner", TextAlign.left,
                             ColorManager.blackColor)
                             :
                         index == 3 ?
                         width > 800
                             ? textStyle2("Donation Banner", TextAlign.left,
                             ColorManager.blackColor)
                             : textStyle0_5("Donation Banner", TextAlign.left,
                             ColorManager.blackColor)
                             :
                         index == 4 ?
                         width > 800
                             ? textStyle2("Event Detail Banner", TextAlign.left,
                             ColorManager.blackColor)
                             : textStyle0_5("Event Detail Banner", TextAlign.left,
                             ColorManager.blackColor)
                             :
                         index == 5 ?
                         width > 800
                             ? textStyle2("Feedback Banner", TextAlign.left,
                             ColorManager.blackColor)
                             : textStyle0_5("Feedback Banner", TextAlign.left,
                             ColorManager.blackColor)
                       ...
                       DataCell(
                         ...
                         index == 4 ?
                         CustomTextField(
                             controller: _eventDetailUrlController,
                             hintName: StringsManager.eventUrl,
                             isLarge: width > 800 ? true : false)
                             :
                         index == 5 ?
  ...
  uploadImageToStorage(PickedFile? pickedFile, int index) async {
    if(index == 0){
      ...
      Reference reference = FirebaseStorage.instance.ref().child("HomeTopBanner/$dateTime");
    ...
    if(index == 1){
      ...
      DateTime dateTime = DateTime.now();
      Reference reference = FirebaseStorage.instance.ref().child("HomeBottomBanner/$dateTime");
      await reference.putData(await pickedFile!.readAsBytes(), SettableMetadata(contentType: 'image/jpeg'));
    ...
    if(index == 2){
      ...
      DateTime dateTime = DateTime.now();
      Reference reference = FirebaseStorage.instance.ref().child("VolunteerBanner/$dateTime");
      await reference.putData(await pickedFile!.readAsBytes(), SettableMetadata(contentType: 'image/jpeg'));
    ...
    if(index == 3){
      ...
      setState(() { loading4 = false; });
    }
    if(index == 4){
      setState(() { loading5 = true; });
      DateTime dateTime = DateTime.now();
